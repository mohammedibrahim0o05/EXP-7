...
## Aim: 
To create a smart contract that integrates AI logic for automated negotiation in decentralized commerce. 
The contract adjusts price and conditions dynamically based on real-time market trends using an 
on-chain AI model. 
...
4. The contract automatically generates a counteroffer if the buyer’s price is within the negotiation 
range. 
...
<img width="1432" height="1029" alt="Screenshot 2025-11-06 091908" src="https://github.com/user-attachments/assets/bacbc0be-4e96-4ace-a0ef-423dee990d55" />

## Result:
Thus, To create a smart contract that integrates AI logic for automated negotiation in decentralized commerce is successfully verified.
